	...
	<div id="container">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<form method="post" action="<?php echo e(action('ProfessorController@update', $id)); ?>">
					<?php echo csrf_field(); ?>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="nome" value="<?php echo e($professor->nome); ?>" required>
							</div>
						</div>
						...
						<div class="col-md-3">
							...
							<div class="form-group">
								...
								<input type="date" class="form-control" name="data_nascimento" value="<?php echo e($professor->data_nascimento); ?>" required>
							</div>
