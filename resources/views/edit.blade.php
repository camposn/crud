	...
	<div id="container">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<form method="post" action="{{action('AlunoController@update', $id)}}">
					@csrf
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="number" class="form-control" id="cep" name="cep" value="{{$aluno->cep}}" value="" size="10" maxlength="9"
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="number" class="form-control" name="numero" value="{{$aluno->numero}}" required>
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="estado" class="form-control" id="estado" name="estado" value="{{$aluno->estado}}" required>
